...
#ifndef DIFFERENTIALDECODER_IMPL_BASE_H
#define DIFFERENTIALDECODER_IMPL_BASE_H
...
class DifferentialDecoder_base;
...
class DifferentialDecoder_base : public Resource_impl
{
    public:
        DifferentialDecoder_base(const char *uuid, const char *label);
    ...
    protected:
        ProcessThread<DifferentialDecoder_base> *serviceThread; 
